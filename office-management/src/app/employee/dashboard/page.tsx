        ...
        <div className="max-w-[1750px] mx-auto space-y-8">
          ...
          <header className="px-2 text-left flex justify-between items-end">
            <div>
              ...
              <h1 className="text-4xl font-bold tracking-tight text-white ">Aura <span className="not-italic font-black text-transparent bg-clip-text bg-white">Intelligence.</span></h1>
            </div>
